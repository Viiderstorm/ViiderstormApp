...
/*
* WebGL Render
* string id = DOMElement ID for the rendering canvas
* integer width - width of the canvas in screen pixels
* integer height - height of the canvas in screen pixels 
*/
function SceneRenderer(id,width, height){
    ...
    /*
    * Sets the next image to draw
    * RenderTarget nextFrame - texture to draw into the canvas
    */
    ...
    */ 
    ...
    /*
    * Render the current frame into the canvas
    */
